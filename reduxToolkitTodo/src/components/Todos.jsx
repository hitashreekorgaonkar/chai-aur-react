...
function Todos() {
  ...
  return (
    <>
      ...
      ></input>{" "}
      <div className="pt-5 text-lg font-b">Todos</div>
        ...
        {todos.map((todo) => (
          ...
          >
            ...
            {isEditing ? (
              ...
              <button
                onClick={() => edit(todo.id, todo.text)}
                className="text-white bg-yellow-300 border-0 py-1 px-4 focus:outline-none hover:bg-red-600 rounded text-md"
              >
                Edit
              </button>
            )}
